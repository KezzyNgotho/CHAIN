...
mod Token {
    ...
    impl TokenImpl of super::IToken<ContractState> {
        fn mint(ref self: ContractState, to: ContractAddress, amount: u256) {
            ...
            updated_balance.amount += amount;
            updated_balance.last_updated = get_block_timestamp();
            self.balances.write(to, updated_balance);
        ...
        fn transfer(ref self: ContractState, to: ContractAddress, amount: u256) {
            ...
            updated_from_balance.amount -= amount;
            updated_from_balance.last_updated = get_block_timestamp();
            self.balances.write(caller, updated_from_balance);

            let mut to_balance = self.balances.read(to);
            let mut updated_to_balance = to_balance;
            updated_to_balance.amount += amount;
            updated_to_balance.last_updated = get_block_timestamp();
            self.balances.write(to, updated_to_balance);
        ...
        fn stake(ref self: ContractState, market_id: u32, amount: u256) {
            ...
            updated_balance.amount -= amount;
            updated_balance.last_updated = get_block_timestamp();
            self.balances.write(caller, updated_balance);
        ...
        fn unstake(ref self: ContractState, market_id: u32) {
            ...
            let mut balance = self.balances.read(caller);
            let mut updated_balance = balance;
            updated_balance.amount += staked_amount;
            updated_balance.last_updated = get_block_timestamp();
            self.balances.write(caller, updated_balance);
