...
class WalletService extends ChangeNotifier {
  ...
  // Exchange rate (1 CASS = X USDT)
  final double _cassToUsdtRate = 0.85; // Example rate: 1 CASS = 0.85 USDT

  bool get isConnected => _isConnected;
  String? get address => _address;
  double get balance => _balance;
  double get balanceInUsdt => _balance * _cassToUsdtRate;
  double get cassToUsdtRate => _cassToUsdtRate;
  ...
  Future<List<String>> _requestArgentXConnection() async {
    // Return dummy address for testing
    return [
  ...
  Future<void> _updateBalance() async {
    ...
    try {
      _error = null;
      // For testing, set a fixed balance of 150 CASS
      _balance = 150.0;
      notifyListeners();

      // Comment out the actual RPC call for now
      /*
