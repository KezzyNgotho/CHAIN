...
class _FeedPageState extends State<FeedPage>
  ...
  void _toggleLike() {
    setState(() {
      isLiked = !isLiked;
      if (isLiked) {
        currentFeed[currentIndex]['likes'] = (currentFeed[currentIndex]['likes'] as int) + 1;
      } else {
        currentFeed[currentIndex]['likes'] = (currentFeed[currentIndex]['likes'] as int) - 1;
      }
    });
...
class _FeedPageState extends State<FeedPage>
  ...
  late AnimationController _animationController;
  late Animation<double> _fadeAnimation;
  int currentIndex = 0; // Add this line to track current prediction
          ...
          child: Column(
            ...
            children: [
              _FloatingActionIcon(
                ...
                label: 'Like',
                onTap: () => _toggleLike(currentIndex),
                color: Theme.of(context).colorScheme.primary,
              ),
