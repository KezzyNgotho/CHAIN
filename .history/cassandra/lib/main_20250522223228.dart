  ...
  return ThemeData(
    ...
    textTheme: GoogleFonts.interTextTheme(
      ThemeData.dark().textTheme.copyWith(
        ...
        bodyMedium: const TextStyle(fontSize: 14, color: Color(0xFFDDDDDD)),
        bodySmall: const TextStyle(fontSize: 12, color: Color(0xFFDDDDDD)),
        labelLarge: const TextStyle(
          fontSize: 13,
          fontWeight: FontWeight.w600,
          color: Color(0xFFFFFFFF),
        ),
        labelMedium: const TextStyle(fontSize: 12, color: Color(0xFFFFFFFF)),
      ),
    ),
    ...
    dialogTheme: DialogTheme(
      ...
      contentTextStyle: GoogleFonts.inter(fontSize: 13, color: const Color(0xFFDDDDDD)),
    ),
    ...
    splashColor: const Color(0xFFFFFFFF).withOpacity(0.08),
    highlightColor: const Color(0xFFFFFFFF).withOpacity(0.06),
    hoverColor: const Color(0xFFFFFFFF).withOpacity(0.06),
...
ThemeData getThemeData(AppTheme theme) {
  return ThemeData(
    ...
    dialogTheme: DialogTheme(
      ...
      contentTextStyle: GoogleFonts.inter(fontSize: 13, color: Colors.white70),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: const BorderSide(color: Color(0xFF00FFF7), width: 1.2),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 20),
        textStyle: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13),
      ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: const BorderSide(color: Color(0xFF7DF9FF), width: 1),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: const BorderSide(color: Color(0xFF7DF9FF), width: 1),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: const BorderSide(color: Color(0xFF00FFF7), width: 1.5),
      ),
    ...
    dividerColor: const Color(0xFF222222),
    splashColor: const Color(0xFF00FFF7).withOpacity(0.10),
    highlightColor: const Color(0xFF00FFF7).withOpacity(0.08),
    hoverColor: const Color(0xFF00FFF7).withOpacity(0.08),
    visualDensity: VisualDensity.adaptivePlatformDensity,
    materialTapTargetSize: MaterialTapTargetSize.padded,
  );
}
