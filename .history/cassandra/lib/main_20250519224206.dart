  ...
  switch (theme) {
    ...
    case AppTheme.livelyDark:
      return ThemeData(
        ...
        colorScheme: ColorScheme.dark(
          primary: const Color(0xFF7B61FF),
          secondary: const Color(0xFFB388FF),
          background: const Color(0xFF10111A),
    ...
    case AppTheme.sunset:
      return ThemeData(
        ...
        colorScheme: ColorScheme.light(
          ...
          onPrimary: Colors.white,
          onSecondary: Colors.white,
          onBackground: Colors.deepOrange[900]!,
    ...
    case AppTheme.candy:
      return ThemeData(
        ...
        primaryColor: const Color(0xFFFF5CA7),
        colorScheme: ColorScheme.light(
          primary: const Color(0xFFFF5CA7),
          secondary: const Color(0xFFFFB6F9),
          background: const Color(0xFFFFF0F6),
          surface: Colors.white,
          onPrimary: Colors.white,
          onSecondary: Colors.white,
          onBackground: Colors.pink[900]!,
          onSurface: Colors.pink[900]!,
        ),
        textTheme: GoogleFonts.poppinsTextTheme(
          ThemeData.light().textTheme.apply(bodyColor: Colors.pink[900]),
        ),
        appBarTheme: const AppBarTheme(
          backgroundColor: Color(0xFFFFF0F6),
          elevation: 0,
          iconTheme: IconThemeData(color: Color(0xFFFF5CA7)),
        ),
        cardTheme: CardTheme(
          color: Colors.white,
          shape: RoundedRectangleBorder(
    ...
    case AppTheme.midnight:
      return ThemeData(
        ...
        colorScheme: ColorScheme.dark(
          ...
          background: const Color(0xFF181A24),
    ...
    case AppTheme.lemonade:
      return ThemeData(
        ...
        textTheme: GoogleFonts.poppinsTextTheme(
          ThemeData.light().textTheme.apply(bodyColor: Colors.brown[900]),
        ),
        appBarTheme: const AppBarTheme(
          backgroundColor: Color(0xFFFFFDE7),
          elevation: 0,
          iconTheme: IconThemeData(color: Color(0xFFFFEB3B)),
        ),
        cardTheme: CardTheme(
          color: Colors.white,
          shape: RoundedRectangleBorder(
...
class _ThemeControllerState extends State<ThemeController> {
  AppTheme _currentTheme = AppTheme.livelyDark;
                        ...
                        AppTheme.values.map((theme) {
                          ...
                          switch (theme) {
                            ...
                            case AppTheme.candy:
                              ...
                              desc = 'Sweet & Fluffy';
                              previewColors = [
                                const Color(0xFFFF5CA7),
                                const Color(0xFFFFB6F9),
                              ];
                              break;
                            case AppTheme.midnight:
                              name = 'Midnight';
