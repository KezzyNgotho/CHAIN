...
class MainScaffold extends StatefulWidget {
  ...
  const MainScaffold({super.key, required this.currentTheme, required this.onThemeChanged});
                    ...
                    children: AppTheme.values.map((theme) {
                      ...
                      switch (theme) {
                        case AppTheme.livelyLight:
                          name = 'Lively Light';
                          desc = 'Bright & Social';
                          previewColors = [const Color(0xFF7B61FF), const Color(0xFFB388FF)];
                          break;
                        case AppTheme.livelyDark:
                          name = 'Lively Dark';
                          desc = 'Modern & Neon';
                          previewColors = [const Color(0xFF7B61FF), const Color(0xFF23263A)];
                          break;
                        case AppTheme.forest:
                          name = 'Forest';
                          desc = 'Nature-inspired';
                          previewColors = [const Color(0xFF388E3C), const Color(0xFFA5D6A7)];
                          break;
                        case AppTheme.sunset:
                          name = 'Sunset';
                          desc = 'Warm & Vibrant';
                          previewColors = [const Color(0xFFFF7043), const Color(0xFFFFB74D)];
                          break;
                        case AppTheme.ocean:
                          name = 'Ocean';
                          desc = 'Cool & Fresh';
                          previewColors = [const Color(0xFF0288D1), const Color(0xFFB3E5FC)];
                          break;
                      }
