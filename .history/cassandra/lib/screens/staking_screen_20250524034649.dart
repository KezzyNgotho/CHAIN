...
class _StakingScreenState extends State<StakingScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      final stake =
          await _starknetService.getStake(_starknetService.userAddress ?? '');
  ...
  Future<void> _startStaking() async {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _StatRow(
                    label: 'Total Staked',
                    value:
                        '${(BigInt.parse(_stats!['totalStaked']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                  ...
                  _StatRow(
                    label: 'Average Stake',
                    value:
                        '${(BigInt.parse(_stats!['averageStake']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                  const SizedBox(height: 8),
                  _StatRow(
                    label: 'Total Rewards',
                    value:
                        '${(BigInt.parse(_stats!['totalRewards']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                  const SizedBox(height: 8),
                  _StatRow(
                    label: 'Current APY',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _StatRow(
                      label: 'Amount',
                      value:
                          '${(BigInt.parse(_stake!['amount']) / BigInt.from(1e18)).toString()} tokens',
                    ),
                    const SizedBox(height: 8),
                    _StatRow(
                      label: 'Start Time',
                    ...
                    _StatRow(
                      label: 'Total Rewards',
                      value:
                          '${(BigInt.parse(_stake!['totalRewards']) / BigInt.from(1e18)).toString()} tokens',
                    ),
                    const SizedBox(height: 16),
                    Row(
                      children: [
