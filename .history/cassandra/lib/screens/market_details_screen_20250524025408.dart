...
class _MarketDetailsScreenState extends State<MarketDetailsScreen> {
  ...
  Future<void> _loadPredictionDetails() async {
    ...
    try {
      final details = await widget.starknetService.getPredictionDetails(widget.marketId);
      setState(() {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Yes Pool: ${predictionDetails!['yesPool']} ETH'),
                              Text('No Pool: ${predictionDetails!['noPool']} ETH'),
                              Text('Total Staked: ${predictionDetails!['totalStaked']} ETH'),
                              Text('End Time: ${predictionDetails!['endTime']}'),
                            ],
                          ),
                        ),
                      ),
