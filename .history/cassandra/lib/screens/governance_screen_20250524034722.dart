              ...
              child: Column(
                ...
                children: [
                  ...
                  _StatRow(
                    label: 'Total Votes',
                    value:
                        '${(BigInt.parse(_stats!['totalVotes']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                  const SizedBox(height: 8),
                  _StatRow(
                    label: 'Total Voters',
                  ...
                  _StatRow(
                    label: 'Quorum',
                    value:
                        '${(BigInt.parse(_stats!['quorum']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                  const SizedBox(height: 8),
                  _StatRow(
                    label: 'Min Proposal Stake',
                    value:
                        '${(BigInt.parse(_stats!['minProposalStake']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                ],
              ),
            ),
