...
class ProfileScreen extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatRow('Successful Predictions', '${user.successfulPredictions}'),
            _buildStatRow('Success Rate', '${(user.successfulPredictions / user.totalPredictions * 100).toStringAsFixed(1)}%'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...stakes.where((s) => s.isActive).map((stake) => _buildStakeItem(stake)),
          ],
        ),
      ),
    );
  ...
  Widget _buildProposalsSection(List<Proposal> proposals) {
    final userProposals = proposals.where((p) => p.proposer.id == 'alice').toList();
  ...
  Widget _buildCurationsSection(List<Curation> curations) {
    final userCurations = curations.where((c) => c.curator.id == 'alice').toList();
