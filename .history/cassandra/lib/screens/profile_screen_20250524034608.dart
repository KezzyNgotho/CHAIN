...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      final profile = await _starknetService.getUserProfile(_starknetService.userAddress ?? '');
              ...
              child: Column(
                ...
                children: [
                  ...
                  _StatRow(
                    ...
                    value: '${(BigInt.parse(_profile!['governancePower']) / BigInt.from(1e18)).toString()} tokens',
                  ),
                ],
              ),
            ),
