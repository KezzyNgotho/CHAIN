      ...
      if (historyPredictions.isEmpty) {
        return Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.history, size: 48, color: theme.colorScheme.primary.withOpacity(0.18)),
              const SizedBox(height: 12),
              Text('No history yet', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurface.withOpacity(0.7))),
            ],
          ),
        );
      }
      return ListView.separated(
        ...
        itemBuilder: (context, i) {
          ...
          return GestureDetector(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 10),
                            Icon(Icons.access_time, color: theme.colorScheme.secondary, size: 14),
                            const SizedBox(width: 2),
                            Text(
                              pred['time']!,
                              style: theme.textTheme.bodySmall?.copyWith(
                        ...
                        Row(
                          children: [
                            Icon(Icons.attach_money, color: theme.colorScheme.primary, size: 14),
                            const SizedBox(width: 2),
                            Text(
                              pred['amount']!,
                              style: theme.textTheme.bodySmall?.copyWith(
                            ...
                            IconButton(
                              icon: Icon(Icons.share, color: theme.colorScheme.secondary, size: 20),
                              onPressed: () {},
                              tooltip: 'Share',
                              splashRadius: 22,
                            ),
            ...
            ).animate().fadeIn(duration: 300.ms).scale(delay: (i * 80).ms, duration: 300.ms),
          );
        },
      );
    }
      ...
      if (likedPredictions.isEmpty) {
        return Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.favorite, size: 48, color: theme.colorScheme.tertiary.withOpacity(0.18)),
              const SizedBox(height: 12),
              Text('No liked predictions yet', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurface.withOpacity(0.7))),
            ],
          ),
        );
      }
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.favorite, color: theme.colorScheme.tertiary, size: 22),
                  ),
                  const SizedBox(width: 14),
                  Expanded(
                    child: Column(
                          ...
                          children: [
                            ...
                            IconButton(
                              icon: AnimatedSwitcher(
                                ...
                                child: liked
                                    ? Icon(Icons.favorite, key: ValueKey(true), color: theme.colorScheme.tertiary, size: 20)
                                    : Icon(Icons.favorite_border, key: ValueKey(false), color: theme.colorScheme.tertiary, size: 20),
                              ),
                              onPressed: () {
