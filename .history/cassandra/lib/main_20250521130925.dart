  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        ...
        borderSide: const BorderSide(color: Color(0xFF90CAF9), width: 1.2), // Crystal Blue
      ),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: const BorderSide(color: Color(0xFF00E5FF), width: 2), // Electric Cyan
      ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          UserAvatar(name: '@username', radius: 16),
                  ...
                  AnimatedTap(
                    ...
                    child: IconButton(
                      icon: Icon(
                        ...
                        color: widget.liked ? accent : theme.iconTheme.color,
                        size: 20,
