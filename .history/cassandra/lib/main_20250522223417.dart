  ...
  return ThemeData(
    ...
    textTheme: GoogleFonts.interTextTheme(
      ThemeData.dark().textTheme.copyWith(
        ...
        bodyMedium: const TextStyle(fontSize: 13, color: Color(0xFFDDDDDD)), // Reduced from 14
        bodySmall: const TextStyle(fontSize: 11, color: Color(0xFFDDDDDD)), // Reduced from 12
        labelLarge: const TextStyle(
          fontSize: 12, // Reduced from 13
          fontWeight: FontWeight.w600,
          color: Color(0xFFFFFFFF),
        ),
        labelMedium: const TextStyle(fontSize: 11, color: Color(0xFFFFFFFF)), // Reduced from 12
      ),
    ),
    ...
    cardTheme: CardTheme(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)), // Reduced from 10
      elevation: 0,
      shadowColor: Colors.transparent,
      margin: const EdgeInsets.symmetric(vertical: 4, horizontal: 4), // Reduced from 6
    ),
