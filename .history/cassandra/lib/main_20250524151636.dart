      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.leaderboard_outlined, color: Theme.of(context).colorScheme.secondary),
            ...
            ListTile(
              leading: Icon(Icons.settings_outlined, color: Theme.of(context).colorScheme.tertiary),
