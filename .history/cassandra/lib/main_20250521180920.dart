...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget _buildProfileTabContent(int tab, ThemeData theme) {
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.show_chart, color: theme.colorScheme.primary, size: 22),
                  ),
                  const SizedBox(width: 14),
                  Expanded(
                    child: Column(
    ...
    // TODO: Add History and Likes tab content
    if (tab == 1) {
      return Center(child: Text('History tab coming soon!', style: theme.textTheme.bodyMedium));
    }
    if (tab == 2) {
      return Center(child: Text('Likes tab coming soon!', style: theme.textTheme.bodyMedium));
    }
    return const SizedBox.shrink();
  }
}
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(icon, color: selected ? color : color.withOpacity(0.5), size: 18),
              const SizedBox(height: 2),
              Text(
                label,
