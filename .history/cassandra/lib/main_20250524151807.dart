      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.how_to_vote_outlined, color: Theme.of(context).colorScheme.primary),
              title: const Text('Active Proposals'),
              onTap: () {
                Navigator.pop(context);
                // TODO: Navigate to Active Proposals
              },
            ),
            ListTile(
            ...
            ListTile(
              leading: Icon(Icons.stacked_line_chart_outlined, color: Theme.of(context).colorScheme.primary),
              title: const Text('Staking Pools'),
              onTap: () {
                Navigator.pop(context);
                // TODO: Navigate to Staking Pools
              },
            ),
            ListTile(
              leading: Icon(Icons.emoji_events_outlined, color: Theme.of(context).colorScheme.secondary),
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'dart:math';
import 'package:flutter/services.dart';
