  ...
  return ThemeData(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: const Color(0xFF7DF9FF),
        side: const BorderSide(color: Color(0xFF7DF9FF), width: 1.5),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
        padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 24),
        textStyle: const TextStyle(
          fontWeight: FontWeight.w600,
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        ...
        borderSide: const BorderSide(color: Color(0xFF7DF9FF), width: 1.2),
      ),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(14),
        borderSide: const BorderSide(color: Color(0xFF9B5CFF), width: 1.5),
      ),
      hintStyle: const TextStyle(color: Colors.white38, fontSize: 15),
      contentPadding: const EdgeInsets.symmetric(vertical: 16, horizontal: 18),
    ),
    iconTheme: const IconThemeData(color: Color(0xFF7DF9FF)),
    dividerColor: const Color(0xFF1A1A1F),
    splashColor: const Color(0xFF9B5CFF).withOpacity(0.12),
    highlightColor: const Color(0xFF9B5CFF).withOpacity(0.08),
    hoverColor: const Color(0xFF9B5CFF).withOpacity(0.08),
...
void main() async {
  ...
  try {
    ...
    // Continue without environment variables - they will be handled by WalletService
  }
...
class _ThemeControllerState extends State<ThemeController> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<WalletService>(context, listen: false).checkSavedConnection();
    });
  }
...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          // Top bar - only show if not on profile page
          if (_selectedIndex != 3)
            Container(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildNavItem(1, Icons.gavel_outlined, 'Governance'),
                _buildLiveButton(),
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return PredictionCard(
                ...
                mediaType: pred['mediaType'] as String,
                mediaUrl: pred['mediaUrl'] as String,
                user: pred['user'] as Map<String, dynamic>,
              );
            },
          ),
        ),
...
class _ProfilePageState extends State<ProfilePage> {
    ...
    return Consumer<WalletService>(
      builder: (context, walletService, child) {
        if (!walletService.isConnected) {
          return _buildNotConnectedView(theme);
        }
        return _buildConnectedView(theme, walletService);
      },
    );
  }

  Widget _buildNotConnectedView(ThemeData theme) {
    return Scaffold(
  ...
  Widget _buildConnectedView(ThemeData theme, WalletService walletService) {
    return Scaffold(
      backgroundColor: theme.scaffoldBackgroundColor,
      appBar: AppBar(
      ...
      body: ListView(
        ...
        children: [
              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    UserAvatar(name: walletService.address, radius: 26),
                  ],
                ),
            ...
            children: [
              Expanded(
                child: _buildActionButton(
                  ...
                  label: 'Deposit CASS',
                  onTap: () {
                    // TODO: Implement CASS token deposit
                  },
                  color: theme.colorScheme.primary,
                ),
              ),
              ...
              Expanded(
                child: _buildActionButton(
                  ...
                  label: 'Withdraw CASS',
                  onTap: () {
                    // TODO: Implement CASS token withdrawal
                  },
                  color: theme.colorScheme.secondary,
                ),
              ),
              ...
              Expanded(
                child: _buildActionButton(
                  ...
                  label: 'Swap CASS',
                  onTap: () {
                    // TODO: Implement CASS token swap
                  },
                  color: theme.colorScheme.tertiary,
                ),
              ),
          ...
          _buildActivityItem(
            ...
            title: 'Staked on BTC Prediction',
            subtitle: '2h ago',
            amount: '+0.5 ETH',
            isPositive: true,
          ),
...
// Update the gradient painter for a more subtle effect
class _AnimatedGradientPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gradient = LinearGradient(
      colors: [
        Color.lerp(const Color(0xFF9B5CFF), const Color(0xFF7DF9FF), t)!,
        Color.lerp(const Color(0xFF7DF9FF), const Color(0xFF9B5CFF), t)!,
      ],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    );
...
// Update the particle painter for a more subtle effect
class _ParticlePainter extends CustomPainter {
  final double t;
  _ParticlePainter(this.t);
  final int count = 12; // Reduced number of particles
  @override
  void paint(Canvas canvas, Size size) {
    final rnd = Random(42);
    for (int i = 0; i < count; i++) {
      ...
      final radius = 1.0 + rnd.nextDouble() * 2.0; // Smaller particles
      final color = [
        const Color(0xFF9B5CFF),
        const Color(0xFF7DF9FF),
      ][i % 2]
          .withOpacity(0.12 + 0.08 * rnd.nextDouble()); // More subtle opacity
...
// Update the glass button for a more subtle effect
