            ...
            child: BottomNavigationBar(
              ...
              items: [
                ...
                BottomNavigationBarItem(
                  icon: Container(
                    decoration: BoxDecoration(
                      color: _selectedIndex == 2 ? Theme.of(context).colorScheme.primary : Colors.transparent,
                    ...
                    child: Icon(
                      ...
                      size: 32,
                      color: _selectedIndex == 2 ? Theme.of(context).colorScheme.onPrimary : Theme.of(context).colorScheme.primary,
                      semanticLabel: 'Add',
                    ),
                  ),
                  label: '',
                ...
                BottomNavigationBarItem(
                  icon: Container(
                    ...
                    child: Icon(
                      Icons.live_tv,
                      size: 28,
                      color: _selectedIndex == 3 ? Theme.of(context).colorScheme.tertiary : Theme.of(context).colorScheme.onSurface.withOpacity(0.7),
                      semanticLabel: 'Live',
                    ),
                  ),
                  label: '',
