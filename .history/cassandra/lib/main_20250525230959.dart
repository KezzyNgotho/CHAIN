...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  final List<Widget> _pages = [
    ...
    ProfilePage(), // Changed from Placeholder() to ProfilePage()
    Placeholder(), // MarketsPage
    const MorePage(), // Changed from SettingsPage to MorePage
  ];
...
// Add this new widget after the SettingsPage class
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          // Portfolio Section          _MoreSection(
            title: 'Portfolio',
            items: [
              _MoreItem(
