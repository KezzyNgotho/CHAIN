  ...
  return ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)), // Reduced from 10
        padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 18), // Reduced from 12,20
        elevation: 0,
        shadowColor: Colors.transparent,
        textStyle: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12), // Reduced from 13
      ),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      contentPadding: const EdgeInsets.symmetric(vertical: 10, horizontal: 12), // Reduced from 12,14
    ),
    ...
    highlightColor: const Color(0xFFFFFFFF).withOpacity(0.03), // Reduced from 0.06
