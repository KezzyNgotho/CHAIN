...
ThemeData getThemeData(AppTheme theme) {
  return ThemeData(
    ...
    scaffoldBackgroundColor: const Color(0xFF0A0A12), // Deeper Midnight Black
    primaryColor: const Color(0xFF9B5CFF), // Brighter Starknet Purple
    colorScheme: ColorScheme.dark(
      primary: const Color(0xFF9B5CFF), // Brighter Starknet Purple
      secondary: const Color(0xFF7DF9FF), // Vibrant Crystal Blue
      background: const Color(0xFF0A0A12), // Deeper Midnight Black
      surface: const Color(0xFF181A22), // More contrast
      onPrimary: Colors.white,
      onSecondary: Colors.white,
      onBackground: Colors.white,
      onSurface: Colors.white,
      tertiary: const Color(0xFF00FFF7), // Electric Neon Cyan
    ...
    appBarTheme: const AppBarTheme(
      backgroundColor: Color(0xFF0A0A12), // Deeper Midnight Black
      elevation: 0,
    ...
    cardTheme: CardTheme(
      color: const Color(0xFF181A22), // More contrast
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        // 1. FeedPage top bar: glassy, blurred, floating, neon border/glow
        Positioned(
          top: padding.top + 28, // Slightly higher for floating effect
          left: 0,
          right: 0,
          child: Center(
            child: Container(
