...
ThemeData getThemeData(AppTheme theme) {
  return ThemeData(
    ...
    primaryColor: const Color(0xFF8C52FF), // Plasma Purple
    colorScheme: ColorScheme.dark(
      primary: const Color(0xFF8C52FF), // Plasma Purple
      secondary: const Color(0xFFFF2DCA), // Neon Pink
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: const Color(0xFF4A90E2), // Ocean Blue
    ...
    splashColor: const Color(0xFF4A90E2).withOpacity(0.12),
    highlightColor: const Color(0xFF4A90E2).withOpacity(0.08),
    hoverColor: const Color(0xFF4A90E2).withOpacity(0.08),
  );
}
