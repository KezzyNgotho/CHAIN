...
class StarkNetService {
  ...
  static final _sepoliaChainId = Felt.fromBigInt(BigInt.parse('534e5f5345504f4c4941', radix: 16));
  ...
  Future<bool> connectWallet(String privateKey) async {
    try {
      ...
      final accountClassHash = Felt.fromHexString('0x...'); // Your account class hash
