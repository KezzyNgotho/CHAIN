...
class StarkNetService {
  static const String rpcUrl = 'https://starknet-goerli.infura.io/v3/YOUR_INFURA_KEY';
  ...
  Future<String> getExpectedReturn(String predictionId, bool isYes, String amount) async {
    try {
      final amountWei = BigInt.from(double.parse(amount) * 1e18);
