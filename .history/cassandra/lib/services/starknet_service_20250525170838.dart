...
class StarkNetService {
  ...
  Future<String> createMarket(
    ...
    try {
      ...
      // Convert question and category to felt-compatible strings (UTF-8 to BigInt)
      BigInt stringToFelt(String value) =>
          BigInt.parse(value.codeUnits.map((c) => c.toRadixString(16)).join(),
              radix: 16);

      final calldata = [
        stringToFelt(question).toString(),
        stringToFelt(category).toString(),
        endTime.toString(),
      ];
