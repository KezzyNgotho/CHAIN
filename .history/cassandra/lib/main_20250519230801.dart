                  ...
                  children: [
                    TextField(
                      decoration: InputDecoration(
                        ...
                        hintStyle: theme.textTheme.bodySmall?.copyWith(fontSize: 12),
                        filled: true,
                        fillColor: theme.colorScheme.background,
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(4),
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton.icon(
                            ...
                            onPressed: () {},
                            icon: Icon(Icons.folder_open_outlined, size: 16, color: theme.colorScheme.primary),
                        ...
                        Expanded(
                          child: OutlinedButton.icon(
                            ...
                            onPressed: () {},
                            icon: Icon(Icons.category_outlined, size: 16, color: theme.colorScheme.primary),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.settings, color: theme.appBarTheme.iconTheme?.color ?? theme.iconTheme.color, size: 20),
            onPressed: () {},
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: theme.appBarTheme.elevation ?? 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: theme.appBarTheme.iconTheme?.color ?? theme.iconTheme.color, size: 20),
          onPressed: () => Navigator.pop(context),
        ),
        title: Text(
          'Comments',
