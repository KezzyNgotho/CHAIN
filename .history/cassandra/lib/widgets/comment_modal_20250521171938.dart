...
class _CommentModalState extends State<CommentModal> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Icon(Icons.sort, size: 18, color: theme.colorScheme.secondary),
  ...
  Widget _buildComment({required String user, required String text, required int likes, bool isLiked = false}) {
    final theme = Theme.of(context);
    return Padding(
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(
                icon: Icon(Icons.more_vert, color: theme.colorScheme.onSurface.withOpacity(0.5), size: 18),
                onPressed: () {},
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    Icon(Icons.reply, color: theme.colorScheme.secondary, size: 16),
                    const SizedBox(width: 4),
        ...
        children: [
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: _isReplying && _replyTo != null
                    ? 'Reply to @$_replyTo'
                    : 'Share your take... 💬',
                filled: true,
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                children: [
                  Icon(Icons.send, color: _controller.text.isNotEmpty ? Colors.white : theme.colorScheme.onSurface.withOpacity(0.5)),
                ],
              ),
            ),
          ),
