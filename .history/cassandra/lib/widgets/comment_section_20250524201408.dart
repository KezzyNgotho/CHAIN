        ...
        _comments = [
          {
            ...
            'user': 'Alex Thompson',
            'text':
                'This prediction looks solid! The market trends support this outcome, and the analysis is thorough. I\'m particularly impressed by the consideration of external factors.',
            'timestamp':
          ...
          },
          {
            ...
            'user': 'Sarah Chen',
            'text':
                'I have a different perspective. While the data is compelling, I think we should consider the recent regulatory changes that might impact this outcome.',
            'timestamp':
          ...
          },
          {
            ...
            'text':
                'Great analysis! The historical patterns you\'ve identified are particularly convincing. I\'ve been tracking similar indicators and reached the same conclusion.',
            'timestamp':
          ...
          },
          {
            ...
            'user': 'Emma Wilson',
            'text':
                'Could you elaborate more on the methodology used for this prediction? I\'d love to understand the underlying assumptions better.',
            'timestamp':
                DateTime.now().subtract(const Duration(hours: 6)).toString(),
            'likes': 8,
            'isOwner': false,
            'avatar': '👩‍🎓',
          },
          {
            ...
            'user': 'David Kim',
            'text':
                'The risk assessment seems a bit optimistic. Have you considered the potential impact of market volatility in the current economic climate?',
            'timestamp':
