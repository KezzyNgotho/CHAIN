...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  Widget _buildPage(int index) {
    switch (index) {
      ...
      case 1:
        return const GovernancePage(); // Changed from NotificationsPage
      case 2:
        return const LiveModal(); // Changed from Placeholder to LiveModal
      case 3:
        return const ProfilePage();
      case 4:
        return const Placeholder(); // MorePage
      default:
        return const FeedPage();
    }
  }
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildNavItem(1, Icons.gavel_outlined,
                    'Governance'), // Changed from notifications icon
                _buildLiveButton(),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '${walletService.balance} CASS', // Changed to CASS token
                        style: theme.textTheme.titleMedium?.copyWith(
                          fontWeight: FontWeight.bold,
                          color: theme.colorScheme.onSurface,
                        ),
    ...
    for (int i = 0; i < count; i++) {
      ...
      final color = [
        ...
        const Color(0xFF00E5FF),
          ...
          .withOpacity(0.18 + 0.18 * rnd.nextDouble());
...
class _TypewriterTextState extends State<_TypewriterText>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final count = (widget.text.length * _controller.value)
