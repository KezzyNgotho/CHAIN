          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (_) => const GovernancePage()));
              },
            ),
            // Staking Section
            ListTile(
              leading: Icon(Icons.currency_exchange_outlined, color: Theme.of(context).colorScheme.secondary),
              title: const Text('Staking'),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (_) => const StakingPage()));
              },
            ),
            // Analytics Section
            ListTile(
              leading: Icon(Icons.analytics_outlined, color: Theme.of(context).colorScheme.tertiary),
            ...
            // Leaderboard Section
            ListTile(
              leading: Icon(Icons.leaderboard_outlined, color: Theme.of(context).colorScheme.primary),
            ...
            // Portfolio Section
            ListTile(
              leading: Icon(Icons.account_balance_wallet_outlined, color: Theme.of(context).colorScheme.secondary),
            ...
            // Rewards Section
            ListTile(
              leading: Icon(Icons.card_giftcard_outlined, color: Theme.of(context).colorScheme.tertiary),
