...
class _PredictionCardState extends State<PredictionCard>
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final borderRadius = BorderRadius.circular(12); // Reduced from 24
    final neonGradient = LinearGradient(
      colors: [
        theme.colorScheme.primary.withOpacity(0.5), // Reduced from 0.7
        theme.colorScheme.secondary.withOpacity(0.5), // Reduced from 0.7
        theme.colorScheme.tertiary.withOpacity(0.5), // Reduced from 0.7
      ],
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: theme.colorScheme.tertiary.withOpacity(0.08), // Reduced from 0.15
                ...
                child: ClipRRect(
                  ...
                  child: BackdropFilter(
                    filter: ImageFilter.blur(sigmaX: 12, sigmaY: 12), // Reduced from 18
                    child: Container(
                      decoration: BoxDecoration(
                        color: theme.colorScheme.surface.withOpacity(0.85), // Increased from 0.72
                        borderRadius: borderRadius,
                        border: Border.all(
                          width: 1.5, // Reduced from 2.5
                          color: Colors.white.withOpacity(0.06), // Reduced from 0.08
                        ),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Stack(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.only(
                                    topLeft: Radius.circular(12), // Reduced from 24
                                    topRight: Radius.circular(12), // Reduced from 24
                                  ),
                                  gradient: LinearGradient(
                                    colors: [
                                      theme.colorScheme.primary.withOpacity(0.12), // Reduced from 0.18
                                      theme.colorScheme.secondary.withOpacity(0.08), // Reduced from 0.12
                                    ],
                                    begin: Alignment.topLeft,
                                    end: Alignment.bottomRight,
                                  ),
                                ...
                                child: Center(
                                  child: Icon(
                                    ...
                                    size: 32, // Reduced from 42
                                    shadows: [
                                      Shadow(
                                        color: theme.colorScheme.tertiary.withOpacity(0.3), // Reduced from 0.5
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: theme.colorScheme.secondary.withOpacity(0.12), // Reduced from 0.18
                                    borderRadius: BorderRadius.circular(8), // Reduced from 10
                                    boxShadow: [
                                      BoxShadow(
                                        color: theme.colorScheme.secondary.withOpacity(0.08), // Reduced from 0.12
                              ...
                              if (widget.timeLeft == 'Live')
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.redAccent.withOpacity(0.08), // Reduced from 0.12
                                      borderRadius: BorderRadius.circular(8), // Reduced from 10
                                      boxShadow: [
                                        BoxShadow(
                                          color: Colors.redAccent.withOpacity(0.08), // Reduced from 0.12
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    UserAvatar(name: '@username', radius: 16), // Reduced from 20
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: theme.textTheme.labelSmall?.copyWith(
                                            color: theme.textTheme.bodySmall?.color?.withOpacity(0.5), // Reduced from 0.6
                                ...
                                Text(
                                  ...
                                  style: theme.textTheme.titleMedium?.copyWith(
                                    ...
                                    shadows: [
                                      Shadow(
                                        color: theme.colorScheme.primary.withOpacity(0.3), // Reduced from 0.4
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: theme.colorScheme.secondary.withOpacity(0.2), // Reduced from 0.3
                                        ),
                                        borderRadius: BorderRadius.circular(8), // Reduced from 10
                                        color: theme.colorScheme.secondary.withOpacity(0.06), // Reduced from 0.08
                                      ),
                                      child: Row(
                                        children: [
                                          Icon(
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: theme.colorScheme.tertiary.withOpacity(0.2), // Reduced from 0.3
                                        ),
                                        borderRadius: BorderRadius.circular(8), // Reduced from 10
                                        color: theme.colorScheme.tertiary.withOpacity(0.06), // Reduced from 0.08
                                      ),
                                      child: Row(
                                        children: [
                                          Icon(
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        style: ElevatedButton.styleFrom(
                                          ...
                                          shadowColor: theme.colorScheme.tertiary.withOpacity(0.2), // Reduced from 0.3
                                          padding: const EdgeInsets.symmetric(
                    ...
                    AnimatedTap(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          ...
                          semanticLabel: 'Create Prediction',
                        ),
                      ),
                    ),
                    const SizedBox(height: 16),
