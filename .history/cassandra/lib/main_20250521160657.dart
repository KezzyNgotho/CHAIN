...
class _CreatePredictionScreenState extends State<CreatePredictionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Use a deeper, muted purple for the modal background
    final Color deepPurple = const Color(0xFF5A2D91); // Muted Starknet Purple
    return Container(
      ...
      child: ClipRRect(
        borderRadius: borderRadius,
        child: BackdropFilter(
          filter: ImageFilter.blur(sigmaX: 24, sigmaY: 24), // More frosted
          child: Material(
            color: Colors.transparent,
            child: Column(
              children: [
