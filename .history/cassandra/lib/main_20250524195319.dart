...
class _MarketsPageState extends State<MarketsPage> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final List<String> _categories = ['All', 'Crypto', 'Tech', 'AI', 'Gaming', 'Sports'];
  String _selectedCategory = 'All';
  bool _isLoading = false;
  final RefreshController _refreshController = RefreshController();
  String _sortBy = 'Newest';
  final List<String> _sortOptions = ['Newest', 'Most Staked', 'Ending Soon', 'Trending'];
