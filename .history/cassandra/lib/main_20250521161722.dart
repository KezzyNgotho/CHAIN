...
class _CreatePredictionScreenState extends State<CreatePredictionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFB39DDB).withOpacity(0.92), // Cute pastel purple
        borderRadius: borderRadius,
        border: Border.all(
          color: const Color(0xFF00E5FF).withOpacity(0.18), // Soft pastel cyan
          width: 2,
        ),
        boxShadow: [
          BoxShadow(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.favorite_rounded, color: const Color(0xFF00E5FF).withOpacity(0.7), size: 26),
                      ...
                      Expanded(
                        child: _step < 5
                          ...
                          : ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: canPublish ? const Color(0xFF00E5FF) : theme.disabledColor,
                                foregroundColor: Colors.white,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                                elevation: 8,
                                shadowColor: const Color(0xFF00E5FF).withOpacity(0.3),
