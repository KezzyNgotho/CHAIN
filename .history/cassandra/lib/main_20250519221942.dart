...
class PredictionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderRadius = (theme.cardTheme.shape as RoundedRectangleBorder?)?.borderRadius ?? BorderRadius.circular(10);
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OutlinedButton(
                              ...
                              child: Text('Stake No', style: TextStyle(color: accent)),
                            ),
                          ),
                        ],
                      ),
