...
class FeedPage extends StatelessWidget {
  ...
  void showCreatePredictionModal(BuildContext context) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: const Color(0xFF181A24),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: const Color(0xFF7B61FF),
        child: const Icon(Icons.add, color: Colors.white),
        onPressed: () => showCreatePredictionModal(context),
      ),
    );
  }
}
...
class PredictionCard extends StatelessWidget {
  void showStakeModal(BuildContext context, String stakeOn) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: const Color(0xFF181A24),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () => showStakeModal(context, 'YES'),
                        child: const Text('Stake Yes'),
                      ),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () => showStakeModal(context, 'NO'),
                        child: const Text('Stake No'),
                      ),
                    ),
                  ],
