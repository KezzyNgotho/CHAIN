...
ThemeData getThemeData(AppTheme theme) {
  return ThemeData(
    ...
    scaffoldBackgroundColor: const Color(0xFF0D0D0D), // Midnight Black
    primaryColor: const Color(0xFF8C52FF), // Starknet Purple
    colorScheme: ColorScheme.dark(
      primary: const Color(0xFF8C52FF), // Starknet Purple
      secondary: const Color(0xFF90CAF9), // Crystal Blue
      background: const Color(0xFF0D0D0D), // Midnight Black
      surface: const Color(0xFF181A1B), // Slightly lighter than background
      onPrimary: Colors.white,
      onSecondary: Colors.white,
      onBackground: Colors.white,
      onSurface: Colors.white,
      tertiary: const Color(0xFF00E5FF), // Electric Cyan
    ),
    textTheme: GoogleFonts.soraTextTheme(
      ThemeData.dark().textTheme.copyWith(
        ...
        labelMedium: const TextStyle(fontSize: 12, color: Color(0xFF00E5FF)),
      ),
    ),
    appBarTheme: const AppBarTheme(
      backgroundColor: Color(0xFF0D0D0D), // Midnight Black
      elevation: 0,
    ...
    cardTheme: CardTheme(
      color: const Color(0xFF181A1B), // Slightly lighter than background
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: const Color(0xFF00E5FF), // Electric Cyan
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: const Color(0xFF00E5FF), // Electric Cyan
    ...
    iconTheme: const IconThemeData(color: Color(0xFF00E5FF)), // Electric Cyan
    dividerColor: Colors.white10,
    splashColor: const Color(0xFF00E5FF).withOpacity(0.12),
    highlightColor: const Color(0xFF00E5FF).withOpacity(0.08),
      ...
      child: MaterialApp(
        ...
        home:
            _isLoggedIn
                ...
                : _showSplash
                ? SplashScreen(onContinue: _hideSplash)
                : _showOnboarding
                ? OnboardingScreen(
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          const BottomNavigationBarItem(
            icon: Icon(Icons.notifications, semanticLabel: 'Notifications'),
            label: '',
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Positioned(
          top: padding.top + 36, // Increased drop for better spacing
          left: 0,
          right: 0,
          child: Container(
            ...
            child: Column(
              children: [
                AnimatedTap(
                  ...
                  child: IconButton(
                    icon: Icon(
                      widget.liked ? Icons.favorite : Icons.favorite_outline,
                      color:
                          widget.liked
                              ? theme.colorScheme.tertiary
...
class _CreatePredictionScreenState extends State<CreatePredictionScreen> {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final borderRadius = BorderRadius.vertical(top: Radius.circular(18));
    return Container(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: List.generate(6, (i) => _buildStepDot(i, theme)),
                  ),
                ),
                Divider(color: theme.dividerColor, height: 1, thickness: 1),
                // Content
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _step < 5
                          ...
                          : ElevatedButton(
                              onPressed: canPublish ? () => Navigator.pop(context) : null,
                              style: ElevatedButton.styleFrom(
                                backgroundColor: canPublish ? theme.colorScheme.primary : theme.disabledColor,
                                foregroundColor: Colors.white,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                                elevation: 8,
  ...
  Widget _buildStepDot(int i, ThemeData theme) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isActive ? theme.colorScheme.tertiary : theme.colorScheme.secondary.withOpacity(0.3),
    ...
    switch (_step) {
      case 0:
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Step 1: Write your prediction', style: theme.textTheme.titleMedium),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10),
                  borderSide: BorderSide(color: theme.colorScheme.secondary, width: 1.2),
                ),
                contentPadding: const EdgeInsets.symmetric(vertical: 14, horizontal: 14),
              ),
              maxLength: 240,
              maxLines: 3,
              style: theme.textTheme.bodyMedium?.copyWith(fontSize: 15, color: theme.colorScheme.onSurface),
      ...
      case 1:
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Step 2: Upload image or video (optional)', style: theme.textTheme.titleMedium),
            const SizedBox(height: 10),
            GestureDetector(
                ...
                child: Container(
                  ...
                  child: _mediaPath == null
                      ? Column(
                          ...
                          children: [
                            Icon(Icons.add_a_photo_outlined, color: theme.colorScheme.secondary, size: 32),
                            const SizedBox(height: 8),
                            Text('Tap to upload', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.secondary)),
                          ],
                        )
      ...
      case 2:
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Step 3: Choose outcome type', style: theme.textTheme.titleMedium),
            const SizedBox(height: 10),
            Row(
              children: outcomeTypes.map((type) => Expanded(
                child: Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    onSelected: (selected) {
                      if (selected) setState(() => _outcomeType = type);
                    },
                    selectedColor: theme.colorScheme.tertiary,
                    backgroundColor: theme.colorScheme.surface.withOpacity(0.3),
                    labelStyle: theme.textTheme.bodyMedium?.copyWith(
                      color: _outcomeType == type ? Colors.white : theme.colorScheme.onSurface,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                ),
        ...
        return Column(
          ...
          children: [
            ...
            OutlinedButton.icon(
              ...
              label: Text(_expiry == null ? 'Pick expiry date' : 'Expiry: ${_expiry!.toLocal().toString().split(' ')[0]}'),
              style: OutlinedButton.styleFrom(
                foregroundColor: theme.colorScheme.secondary,
                side: BorderSide(color: theme.colorScheme.secondary),
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
      ...
      case 4:
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Step 5: Choose visibility', style: theme.textTheme.titleMedium),
            const SizedBox(height: 10),
            Column(
              children: visibilityOptions.map((option) => ListTile(
                leading: Icon(
                  option == 'Public'
                      ? Icons.public
                      : option == 'Anonymous'
                          ...
                          : Icons.lock_outline,
                  color: _visibility == option ? theme.colorScheme.tertiary : theme.colorScheme.secondary,
                ),
                title: Text(option, style: theme.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold)),
                subtitle: Text(
                  option == 'Public'
                      ? 'Visible to everyone'
                      : option == 'Anonymous'
                ...
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                tileColor: _visibility == option ? theme.colorScheme.tertiary.withOpacity(0.08) : null,
              )).toList(),
            ),
          ],
        );
      case 5:
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Step 6: Stake initial amount', style: theme.textTheme.titleMedium),
            const SizedBox(height: 10),
            Row(
              children: [
                ChoiceChip(
                  ...
                  backgroundColor: theme.colorScheme.surface.withOpacity(0.3),
                  labelStyle: theme.textTheme.bodyMedium?.copyWith(
                    color: _stakeType == 'STRK' ? Colors.white : theme.colorScheme.onSurface,
                    fontWeight: FontWeight.bold,
                  ),
                ),
                const SizedBox(width: 10),
                ChoiceChip(
                  ...
                  backgroundColor: theme.colorScheme.surface.withOpacity(0.3),
                  labelStyle: theme.textTheme.bodyMedium?.copyWith(
                    color: _stakeType == 'Points' ? Colors.white : theme.colorScheme.onSurface,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ],
