...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  Widget _buildPage(int index) {
    switch (index) {
      ...
      case 2:
        return const Placeholder(); // ExplorePage
      case 3:
        return const Placeholder(); // MarketsPage
      case 4:
                ...
                Consumer<WalletService>(
                  builder: (context, walletService, child) {
                    if (walletService.isConnected) {
                      return _buildWalletInfo(walletService);
                    }
                    return _buildConnectWalletButton();
                  },
                ),
              ],
            ),
  ...
  Widget _buildWalletInfo(WalletService walletService) {
    return GestureDetector(
      onTap: () => _onTabTapped(4), // Navigate to profile
      child: Container(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'Connect your wallet to access your profile,\nview your predictions, and manage your account.',
              style: theme.textTheme.bodyLarge?.copyWith(
              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    UserAvatar(name: walletService.address, radius: 42),
                  ],
                ),
