...
use starknet::storage::{StorageMap, StorageMapTrait};
...
mod token {
    ...
    #[event]
    enum Event {
        TokensMinted { to: ContractAddress, amount: u256 },
        TokensTransferred { from: ContractAddress, to: ContractAddress, amount: u256 },
    }
    ...
    impl TokenImpl of ContractState {
        fn mint(ref self: ContractState, to: ContractAddress, amount: u256) {
            ...
            self.emit(Event::TokensMinted { to, amount });
        }
        ...
        fn transfer(ref self: ContractState, to: ContractAddress, amount: u256) {
            ...
            self.emit(Event::TokensTransferred { from: caller, to, amount });
        }
