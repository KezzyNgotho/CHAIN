...
pub mod Market {
    ...
    #[storage]
    struct Storage {
        markets: StorageMapAccess::<(u32, MarketInfo)>,
        next_market_id: u32,
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        fn validate_market_exists(self: @ContractState, market_id: u32) {
            let market: MarketInfo = self.markets.read((market_id, MarketInfo::default()));
    ...
    impl MarketImpl of super::IMarket<ContractState> {
        fn create_market(ref self: ContractState, description: felt252, end_time: u64) {
            ...
            self.markets.write((market_id, MarketInfo::default()), new_market);
        ...
        fn place_bet(ref self: ContractState, market_id: u32, amount: u256, is_yes: bool) {
            ...
            let mut market: MarketInfo = self.markets.read((market_id, MarketInfo::default()));
            if is_yes {
                market.total_yes += amount;
            } else {
                market.total_no += amount;
            }
            self.markets.write((market_id, MarketInfo::default()), market);
        ...
        fn resolve_market(ref self: ContractState, market_id: u32, outcome: bool) {
            ...
            self.markets.write((market_id, MarketInfo::default()), updated_market);
        ...
        fn get_market_info(self: @ContractState, market_id: u32) -> MarketInfo {
            self.markets.read((market_id, MarketInfo::default()))
        }
    }
} 