...
CREATE_MARKET_SELECTOR = _starknet_keccak("createMarket".encode("ascii")).to_bytes(32, "big")
PLACE_BET_SELECTOR = _starknet_keccak("placeBet".encode("ascii")).to_bytes(32, "big")
GET_MARKET_SELECTOR = _starknet_keccak("getMarket".encode("ascii")).to_bytes(32, "big")
...
async def test_prediction_market():
    try:
        ...
        try:
            ...
            tx = await account.execute_v1(calls=[call], max_fee=100000000000000)  # 0.0001 ETH
