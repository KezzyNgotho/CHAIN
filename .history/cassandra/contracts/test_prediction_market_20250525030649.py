    ...
    try:
        ...
        try:
            ...
            call = Call(
                ...
                selector=contract.functions["create_market"].selector,
        ...
        try:
            market = await contract.functions["get_market_details"].call(market_id=0)
        ...
        try:
            ...
            call = Call(
                to_addr=CONTRACT_ADDRESS,
                selector=contract.functions["place_bet"].selector,
