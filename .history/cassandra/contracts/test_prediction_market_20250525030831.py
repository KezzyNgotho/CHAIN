...
CREATE_MARKET_SELECTOR = compute_hash_on_elements(["createMarket"])
PLACE_BET_SELECTOR = compute_hash_on_elements(["placeBet"])
GET_MARKET_SELECTOR = compute_hash_on_elements(["getMarket"])
    ...
    try:
        ...
        try:
            ...
            call = Call(
                ...
                selector=CREATE_MARKET_SELECTOR,
